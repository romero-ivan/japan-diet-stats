const TRANSLATIONS = {
  ...
  ja: {
    ...
    incomeDataSource: "等価所得ベースの実データ。出典：厚生労働省<a href=\"https://www.mhlw.go.jp/toukei/list/25-1.html\" target=\"_blank\" class=\"wiki-link\" style=\"text-decoration: underline;\">「所得再分配調査」</a>に基づく統計推計（2022年所得）。"
  }
};
